...
private val destinations = listOf(
    TopDestination("discover", R.string.discover, Icons.Outlined.Explore),
    TopDestination("bookings", R.string.bookings, Icons.Outlined.ConfirmationNumber),
    TopDestination("favorites", R.string.favorites, Icons.Outlined.BookmarkBorder),
    TopDestination("profile", R.string.profile, Icons.Outlined.Person),
)
